...
class Native32
{
    ...
    function finish(Context $ctx)
    {
        ...
        $c = $h[0] + $ctx->s[0];              $h[0] = $c & 0x1fff;
        $c = $h[1] + $ctx->s[1] + ($c >> 13); $h[1] = $c & 0x1fff;
        $c = $h[2] + $ctx->s[2] + ($c >> 13); $h[2] = $c & 0x1fff;
        $c = $h[3] + $ctx->s[3] + ($c >> 13); $h[3] = $c & 0x1fff;
        $c = $h[4] + $ctx->s[4] + ($c >> 13); $h[4] = $c & 0x1fff;
        $c = $h[5] + $ctx->s[5] + ($c >> 13); $h[5] = $c & 0x1fff;
        $c = $h[6] + $ctx->s[6] + ($c >> 13); $h[6] = $c & 0x1fff;
        $c = $h[7] + $ctx->s[7] + ($c >> 13); $h[7] = $c & 0x1fff;
        $c = $h[8] + $ctx->s[8] + ($c >> 13); $h[8] = $c & 0x1fff;
        $c = $h[9] + $ctx->s[9] + ($c >> 13); $h[9] = $c & 0x1fff;
